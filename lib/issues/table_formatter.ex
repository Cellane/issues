defmodule Issues.TableFormatter do
  ...
  ## Example
      ...
      "~-5s | ~-6s | ~-99s~n"
  """
  def format_for(column_widths),
    do: map_join(column_widths, " | ", fn width -> "~-#{width}s" end) <> "~n"
  ...
  ## Example
        ...
        "------+--------+----------"
  """
  def separator(column_widths),
    do: map_join(column_widths, "-+-", fn width -> List.duplicate("-", width) end)
end
