defmodule Issues.CLI do
  ...
  def sort_into_descending_order(list_of_issues),
    do: list_of_issues |> Enum.sort(fn i1, i2 -> i1["created_at"] >= i2["created_at"] end)

  def last(list, count), do: list |> Enum.take(count) |> Enum.reverse()
end
